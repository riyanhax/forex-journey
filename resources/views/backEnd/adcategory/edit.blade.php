...
@section('title','Adcategory Edit')
@section('content')
<div class="container">
        <!-- begin::page-header -->
        <div class="page-header">
            <h4>Adcategory Edit</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{url('superadmin/dashboard')}}">Home</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Adcategory Edit</li>
                </ol>
            </nav>
        </div>
        <!-- end::page-header -->
      ...
      <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                 <div class="row">
                       <div class="col-sm-6">
                         <h6 class="card-title">Adcategory Edit</h6>
                       </div>
                       <div class="col-sm-6">
                 ...
                 <div class="row">
                    <div class="col-md-12">
                       <form action="{{url('editor/adcategory/update')}}" method="POST" enctype="multipart/form-data" class="form-row" name="editForm">
                         @csrf
