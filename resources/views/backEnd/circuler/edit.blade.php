...
@section('title','Job Circuler Edit')
@section('content')
<div class="container">
        <!-- begin::page-header -->
        <div class="page-header">
            <h4>Job Circuler Edit</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="{{url('superadmin/dashboard')}}">Home</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Job Circuler Edit</li>
                </ol>
            </nav>
        </div>
        <!-- end::page-header -->
      ...
      <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                 <div class="row">
                       <div class="col-sm-6">
                         <h6 class="card-title">Job Circuler Edit</h6>
                       </div>
                       <div class="col-sm-6">
                 ...
                 <div class="row">
                    <div class="col-md-12">
                       <form action="{{url('admin/circuler/update')}}" method="POST" enctype="multipart/form-data" class="form-row" name="editForm">
                         @csrf
                          <input type="hidden" value="{{$edit_data->id}}" name="hidden_id">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="shortdescription" class="form-control{{ $errors->has('shortdescription') ? ' is-invalid' : '' }} full-featured-non-premium">{{$edit_data->shortdescription}}</textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="exprience" class="form-control{{ $errors->has('exprience') ? ' is-invalid' : '' }}" value="{{$edit_data->exprience}}">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="salary" class="form-control{{ $errors->has('salary') ? ' is-invalid' : '' }}" value="{{$edit_data->salary}}">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="jobresponsibility" class="form-control{{ $errors->has('jobresponsibility') ? ' is-invalid' : '' }} full-featured-non-premium">{{$edit_data->jobresponsibility}}</textarea>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="expaire" class="form-control{{ $errors->has('expaire') ? ' is-invalid' : '' }}" value="{{$edit_data->expaire}}">
