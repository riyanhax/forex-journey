...
extern string S0="---------------- What is our signal ?";
...
extern string S1="---------------- I_Trend Settings";
extern int Band_Period=10;
extern int Band_Deviation=2;
extern int Power_Period=6;
extern int CountBars=300;
extern string S2="---------------- Stoch Settings";
extern int KPeriod=8;
extern int DPeriod=3;
extern int Slowing=4;
extern string S3="---------------- MACD Settings";
extern int FastEMA1=14;
extern int SlowEMA1=26;
extern int MACDSMA1=9;
extern int FastEMA2=14;
extern int SlowEMA2=26;
extern int MACDSMA2=9;
extern string S4="---------------- RSI Settings";
extern int RSIPeriod=14;
extern string S5="---------------- MFI Settings";
...
extern string S7="---------------- Money Management";
extern double Lots=0.1;        // We start with this lots number
extern double Multiplier1=1.5;
...
extern bool ReverseAtLevelX=false;
extern int ReversedLevel=5;
...
int StartYear=2005;      // Year to start (only for backtest)
int StartMonth=1;        // month to start (only for backtest)
int EndYear=2030;        // Year to stop trading (backtest and live)
      ...
      if ((Bid-LastPrice)>=Pips*Point || OpenOrders<1)
        {
         ...
         if (OpenOrders!=0)
           {
            ...
            for(cnt=1;cnt<=OpenOrders;cnt++)
              {
               if (MaxTrades>12) { mylotsi=NormalizeDouble(mylotsi*Multiplier1,2); }
               else { mylotsi=NormalizeDouble(mylotsi*Multiplier2,2); }
              }
           } else { mylotsi=lotsi; }
         if (mylotsi>100) { mylotsi=100; }
         if(ReverseAtLevelX&&CountOrders(OP_SELL,MagicNumber)==(ReversedLevel-1))
         {
            BuyPrice=Ask;
            LastPrice=0;
            if (TakeProfit==0) { tp=0; }
         ...
         else OrderSend(Symbol(),OP_SELL,mylotsi,SellPrice,slippage,sl,tp,"DLM"+MagicNumber,MagicNumber,0,Red);
         return(0);
        }
     }
      ...
      if ((LastPrice-Ask)>=Pips*Point || OpenOrders<1)
        {
         ...
         if (mylotsi>100) { mylotsi=100; }
         if(ReverseAtLevelX&&CountOrders(OP_BUY,MagicNumber)==(ReversedLevel-1))
         {
            BuyPrice=Ask;
            LastPrice=0;
            if (TakeProfit==0) { tp=0; }
         ...
         else OrderSend(Symbol(),OP_BUY,mylotsi,BuyPrice,slippage,sl,tp,"DLM"+MagicNumber,MagicNumber,0,Blue);
         return(0);
        }
     }
   //   } else {
...
int OpenOrdersBasedOnMACD()
  {
   int myOrderType=3;
   if (iMACD(NULL,0,FastEMA1,SlowEMA1,MACDSMA1,PRICE_CLOSE,MODE_MAIN,0)>iMACD(NULL,0,FastEMA2,SlowEMA2,MACDSMA2,PRICE_CLOSE,MODE_MAIN,1)) { myOrderType=2; }
   if (iMACD(NULL,0,FastEMA1,SlowEMA1,MACDSMA1,PRICE_CLOSE,MODE_MAIN,0)<iMACD(NULL,0,FastEMA2,SlowEMA2,MACDSMA2,PRICE_CLOSE,MODE_MAIN,1)) { myOrderType=1; }
   return(myOrderType);
  }
//+------------------------------------------------------------------+
//|                                                                  |
...
int OpenOrdersBasedOni_TrendRSI()
  {
   int myOrderType=3;
   double Buy1_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Buy1_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 1, 0);
   double Buy2_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Buy2_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 1);
   double Buy3_1=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 0);
   double Buy3_2=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 1);
   double Sell1_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Sell1_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 1, 0);
   double Sell2_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Sell2_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 1);
   double Sell3_1=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 0);
   double Sell3_2=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 1);
//----
...
int OpenOrdersBasedOni_TrendRSISto()
  {
   ...
   double Buy2_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Buy2_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 1);
   double Buy3_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Buy3_2=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_SIGNAL, 0);
   double Buy4_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Buy4_2=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 1);
   double Buy5_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Buy5_2=80;
   double Buy6_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Buy6_2=20;
   double Buy7_1=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 0);
   double Buy7_2=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 1);
   double Sell1_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Sell1_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 1, 0);
   double Sell2_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Sell2_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 1);
   double Sell3_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Sell3_2=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_SIGNAL, 0);
   double Sell4_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Sell4_2=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 1);
   double Sell5_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Sell5_2=80;
   double Sell6_1=iStochastic(NULL, 0, KPeriod, DPeriod, Slowing, MODE_EMA, 1, MODE_MAIN, 0);
   double Sell6_2=30;
   double Sell7_1=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 0);
   double Sell7_2=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 1);
//----
...
int OpenOrdersBasedOni_TrRSIStoMFI()
  {
   ...
   double Buy7_1=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 0);
   double Buy7_2=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 1);
   double Buy8_1=iMFI(NULL, 0, MFIPeriod, 0);
   double Buy8_2=iMFI(NULL, 0, MFIPeriod, 1);
   double Sell1_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Sell1_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 1, 0);
   double Sell2_1=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 0);
   double Sell2_2=iCustom(NULL, 0, "i_Trend", 0, 0, 0, Band_Period, Band_Deviation, Power_Period, CountBars, 0, 1);
   ...
   double Sell7_1=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 0);
   double Sell7_2=iRSI(NULL, 0, RSIPeriod, PRICE_CLOSE, 1);
   double Sell8_1=iMFI(NULL, 0, MFIPeriod, 0);
   double Sell8_2=iMFI(NULL, 0, MFIPeriod, 1);
//----
