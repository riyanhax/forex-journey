...
//---- 
   ...
   for( shift=limit; shift>=0; shift--)
      {
      Price1 = iMA(NULL,0,3,0,3,Price,shift);
      Price2 = iMA(NULL,0,3,0,3,Price,shift+1); 
      ...
      for( shift=limit; shift>=0; shift--)
      {
      AvgBulls[shift]=iMAOnArray(Bulls,0,Length,0,ModeMA,shift)/Point;     
      AvgBears[shift]=iMAOnArray(Bears,0,Length,0,ModeMA,shift)/Point;
      }
