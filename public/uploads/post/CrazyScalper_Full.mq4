...
extern bool Log = FALSE;    // Изменить размер ЛОГ файла
...
int start() {
   ...
   if (OR_Level < li_0) OR_Level = li_0;
...
if (UseTradingHours)
   ...
   if (A(ld_60, li_104, f0_11(Lotos))) {
      if (ticket_76 > 0 && ticket_100 > 0) f0_5(ticket_76);
   ...
   if (ticket_76 < 0) {
      if (TakeProfit > 0) ld_20 = Ask + TakeProfit * Point;
      else ld_20 = 0;
      if (Lotos == 0.0) Lotos = f0_4(OP_BUY);
      f0_8(NULL, OP_BUY, Lotos, 0, ld_20, MagicNumber);
   }
   if (A(ld_68, li_128, f0_11(Lotos))) {
      if (ticket_80 > 0 && ticket_124 > 0) f0_5(ticket_80);
      f0_0(Symbol(), -1, MagicNumber + 2);
      f0_6(Symbol(), -1, MagicNumber + 2);
   }
   if (B(ticket_124, order_open_price_108, Ask, AV_Level, Point)) f0_7(Symbol(), OP_BUYSTOP, NormalizeDouble(order_lots_116 * koef_av, lot_digits), NormalizeDouble(Ask + OR_Level * Point, Digits), 0, 0, MagicNumber + 2);
   if (C(ticket_124, ticket_80, Bid, order_open_price_44, Lock_Level, Point)) f0_8(NULL, OP_BUY, NormalizeDouble(order_lots_52 * koef_l, lot_digits), 0, 0, MagicNumber + 2);
   if (ticket_80 < 0) {
      if (TakeProfit > 0) ld_20 = Bid - TakeProfit * Point;
      else ld_20 = 0;
      if (Lotos == 0.0) Lotos = f0_4(OP_SELL);
...
void f0_8(string a_symbol_0, int a_cmd_8, double ad_12, double a_price_20 = 0.0, double a_price_28 = 0.0, int a_magic_36 = 0, string as_40 = "") {
   ...
   for (int li_88 = 1; li_88 <= 5; li_88++) {
      if (!IsTesting() && (!IsExpertEnabled()) || IsStopped()) {
         if (Log) Print("OpenPosition(): Stopping function");
         break;
      }
      ...
      if (AccountFreeMarginCheck(Symbol(), a_cmd_8, ad_12) <= 0.0 || GetLastError() == 134/* NOT_ENOUGH_MONEY */) {
         //Alert("пїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅ ", f0_10(a_cmd_8), ", пїЅпїЅпїЅпїЅпїЅ=", ad_12, ", пїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅ пїЅпїЅ пїЅпїЅпїЅпїЅпїЅпїЅпїЅ.");
         return;
      }
		if (trade) 
		{
      ...
      if (price_64 == 0.0 && price_72 == 0.0) f0_3("Check in the Review of the market presence of the symbol " + a_symbol_0);
      if (Log) Print("Error(", error_84, ") opening position: ", ErrorDescription(error_84), ", try ", li_88);
      if (Log) Print("Ask=", price_64, " Bid=", price_72, " sy=", a_symbol_0, " ll=", ad_12, " op=", f0_10(a_cmd_8), " pp=", price_56, " sl=", a_price_20, " tp=", a_price_28, " mn=",
         a_magic_36);
...
void f0_5(int a_ticket_0) {
   ...
   if (OrderSelect(a_ticket_0, SELECT_BY_TICKET, MODE_TRADES)) {
      for (int li_48 = 1; li_48 <= 5; li_48++) {
         ...
         if (error_44 == 146/* TRADE_CONTEXT_BUSY */) while (IsTradeContextBusy()) Sleep(11000);
         if (Log) Print("Error(", error_44, ") Close ", OrderType(), " ", ", try ", li_48);
         if (Log) Print(OrderTicket(), "  Ask=", price_20, "  Bid=", price_28, "  pp=", price_36);
         if (Log) Print("sy=", OrderSymbol(), "  ll=", order_lots_12, "  sl=", OrderStopLoss(), "  tp=", OrderTakeProfit(), "  mn=", OrderMagicNumber());
         Sleep(5000);
      }
   } else if (Log) Print("Incorrect trade operation. Close ", OrderType());
}

double f0_11(double ad_0) {
   int digits_8 = Digits;
   double ld_12 = 100;
   if (digits_8 == 3 || digits_8 >= 5) ld_12 = 1000;
      ...
      if (OrderSelect(pos_16, SELECT_BY_POS, MODE_TRADES)) {
         if (OrderSymbol() == as_0 || as_0 == "" && a_cmd_8 < OP_BUY || OrderType() == a_cmd_8) {
            if (OrderType() == OP_BUY || OrderType() == OP_SELL)
               if (a_magic_12 < 0 || OrderMagicNumber() == a_magic_12) f0_5(OrderTicket());
         }
      }
   }
}
...
void f0_7(string a_symbol_0, int a_cmd_8, double ad_12, double a_price_20, double a_price_28 = 0.0, double a_price_36 = 0.0, int a_magic_44 = 0, int a_datetime_48 = 0) {
   ...
   for (int li_88 = 1; li_88 <= 5; li_88++) {
      ...
      if (trade) ticket_92 = OrderSend(a_symbol_0, a_cmd_8, ad_12, a_price_20, Slippage, a_price_28, a_price_36, comment_104, a_magic_44, a_datetime_48, color_52);
      if (ticket_92 > 0) {
         PlaySound("ok");
         return;
      }
      ...
      if (error_84 == 128/* TRADE_TIMEOUT */ || error_84 == 142 || error_84 == 143) {
         ...
         if (Log) Print("Error(", error_84, ") set order: ", error_84, ", try ", li_88);
      } else {
         ...
         if (error_84 == 130/* INVALID_STOPS */) {
            ...
            if (Log) Print("SetOrder(): The price levels are corrected");
         }
         if (Log) Print("Error(", error_84, ") set order: ", error_84, ", try ", li_88);
         if (Log) Print("Ask=", ask_60, "  Bid=", bid_68, "  sy=", a_symbol_0, "  ll=", ad_12, "  op=", a_cmd_8, "  pp=", a_price_20, "  sl=", a_price_28, "  tp=", a_price_36, "  mn=",
            a_magic_44);
         if (ask_60 == 0.0 && bid_68 == 0.0) if (Log) Print("SetOrder(): Check up in the review of the market presence of a symbol " + a_symbol_0);
         if (error_84 == 4/* SERVER_BUSY */ || error_84 == 131/* INVALID_TRADE_VOLUME */ || error_84 == 132/* MARKET_CLOSED */) {
            Sleep(300000);
            return;
         }
            ...
            if (OrderSymbol() == as_0 || as_0 == "" && a_cmd_8 < OP_BUY || cmd_36 == a_cmd_8) {
               if (a_magic_12 < 0 || OrderMagicNumber() == a_magic_12) {
                  for (int li_28 = 1; li_28 <= 5; li_28++) {
                     ...
                     if (Log) Print("Error(", error_20, ") delete order ", cmd_36, ": ", error_20, ", try ", li_28);
                     Sleep(5000);
                  }
               }
            }
...
double f0_4(int a_cmd_0 = 0) {
   ...
   if (Choice_method) free_magrin_4 = AccountBalance();
   ...
   if (minlot_36 > ld_20) minlot_36 = ld_20;
   return (minlot_36);
}

void f0_3(string as_0) {
   Comment(as_0);
   if (StringLen(as_0) > 0) if (Log) Print(as_0);
}
...
void f0_12(double a_order_open_price_0 = -1.0, double a_order_stoploss_8 = 0.0, double a_order_takeprofit_16 = 0.0, int a_datetime_24 = 0) {
   ...
   if (a_order_open_price_0 != ld_36 || a_order_stoploss_8 != ld_60 || a_order_takeprofit_16 != ld_68) {
      for (int li_84 = 1; li_84 <= 5; li_84++) {
         ...
         if (Log) Print("Error(", error_80, ") modifying order: ", ErrorDescription(error_80), ", try ", li_84);
         if (Log) Print("Ask=", ask_44, "  Bid=", bid_52, "  sy=", OrderSymbol(), "  op=" + f0_10(OrderType()), "  pp=", a_order_open_price_0, "  sl=", a_order_stoploss_8, "  tp=",
