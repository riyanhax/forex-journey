/*
   ...
   Website:  h Ttp:/ / w w w .ME t A QU Ot e s.nET
   E-mail :  sUP P O Rt @ M e ta qU O tE S.n e T
*/
#property copyright "Akhmad"
#property link      "akhmad.sna@gmail.com"
...
int start() {
   ...
   if (alertsOn) {
      ...
      if (alertsOnHighLow) {
         if (High[Li_36] > G_ibuf_132[Li_36] && High[Li_36 + 1] < G_ibuf_132[Li_36 + 1]) f0_1("Order SELL Sekarang Juga");
         if (Low[Li_36] < G_ibuf_136[Li_36] && Low[Li_36 + 1] > G_ibuf_136[Li_36 + 1]) f0_1("Order BUY Sekarang Juga");
      } else {
         if (Close[Li_36] > G_ibuf_132[Li_36] && Close[Li_36 + 1] < G_ibuf_132[Li_36 + 1]) f0_1("Penetrated High Bar");
         if (Close[Li_36] < G_ibuf_136[Li_36] && Close[Li_36 + 1] > G_ibuf_136[Li_36 + 1]) f0_1("Penetrated Low Bar");
      }
   }
   return (0);
}

// FB0B60176796F58310772529DFC1D224
void f0_2(int Ai_0) {
   int Li_8;
   double Ld_24;
   double Ld_32;
...
void f0_1(string As_0) {
   ...
   if (Gs_176 != As_0 || G_time_184 != Time[0]) {
      Gs_176 = As_0;
      G_time_184 = Time[0];
      str_concat_8 = StringConcatenate(Symbol(), " Di Jam ", TimeToStr(TimeLocal(), TIME_SECONDS), " Ayo ", As_0);
