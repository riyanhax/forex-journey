...
static input double Martingale_Multiplier=3; // Martingale Multiplier

static input string IndicatorName1 = "Bollinger Bands"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 41; // MA period
input double Slot1IndParam1 = 2.71; // Multiplier
static input string IndicatorName2 = "Moving Average"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 199; // Period
input int Slot2IndParam1 = 4; // Shift
static input string IndicatorName3 = "Oscillator of ATR"; // ------ Indicator parameters ------
input int Slot3IndParam0 = 18; // First ATR period
input int Slot3IndParam1 = 19; // Second ATR period
static input string IndicatorName4 = "ADX"; // ------ Indicator parameters ------
input int Slot4IndParam0 = 2; // Period
input int Slot4IndParam1 = 0; // Level
static input string IndicatorName5 = "Momentum MA Oscillator"; // ------ Indicator parameters ------
input int Slot5IndParam0 = 15; // Momentum period
input int Slot5IndParam1 = 8; // Signal line period
static input string IndicatorName7 = "Rising Volume"; // ------ Indicator parameters ------
input int Slot7IndParam0 = 3; // Volume period
input double Slot7IndParam1 = 2; // Volume threshold
static input string IndicatorName8 = "Bollinger Bands"; // ------ Indicator parameters ------
input int Slot8IndParam0 = 9; // MA period
input double Slot8IndParam1 = 1.97; // Multiplier


static input string ExpertSettings__="------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic=10012708; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   Strategy *strategy = new Strategy(5, 2);

   strategy.StrategyName           = "NZDUSD30M MARTI";
   ...
   strategy.Description            = "Exported on 5/10/2019 from Forex Strategy Builder Professional, v3.8.2";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 206;
   strategy.MinBarsRequired        = 207;
   ...
   strategy.Slot[4].IndicatorName    = "ADX";
   ...
   strategy.Slot[4].IndicatorPointer = indicatorManager.CreateIndicator("ADX", SlotTypes_OpenFilter);
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[0].Text    = "ADX rises";
   ...
   strategy.Slot[4].IndicatorPointer.ListParam[1].Index   = 2;
   strategy.Slot[4].IndicatorPointer.ListParam[1].Text    = "Exponential";
   ...
   strategy.Slot[5].IndicatorName    = "Momentum MA Oscillator";
   ...
   strategy.Slot[5].IndicatorPointer = indicatorManager.CreateIndicator("Momentum MA Oscillator", SlotTypes_OpenFilter);
   ...
   strategy.Slot[5].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[5].IndicatorPointer.ListParam[1].Caption = "Smoothing method";
   strategy.Slot[5].IndicatorPointer.ListParam[1].Index   = 0;
   strategy.Slot[5].IndicatorPointer.ListParam[1].Text    = "Simple";
   strategy.Slot[5].IndicatorPointer.ListParam[2].Enabled = true;
   strategy.Slot[5].IndicatorPointer.ListParam[2].Caption = "Signal line method";
   strategy.Slot[5].IndicatorPointer.ListParam[2].Index   = 2;
   strategy.Slot[5].IndicatorPointer.ListParam[2].Text    = "Exponential";
   strategy.Slot[5].IndicatorPointer.ListParam[3].Enabled = true;
   strategy.Slot[5].IndicatorPointer.ListParam[3].Caption = "Base price";
   strategy.Slot[5].IndicatorPointer.ListParam[3].Index   = 3;
   strategy.Slot[5].IndicatorPointer.ListParam[3].Text    = "Close";

   strategy.Slot[5].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[0].Caption = "Momentum period";
   strategy.Slot[5].IndicatorPointer.NumParam[0].Value   = Slot5IndParam0;
   strategy.Slot[5].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[5].IndicatorPointer.NumParam[1].Caption = "Signal line period";
   ...
   strategy.Slot[6].IndicatorName    = "Bar Closing";
   ...
   strategy.Slot[6].IndicatorPointer = indicatorManager.CreateIndicator("Bar Closing", SlotTypes_Close);
   ...
   strategy.Slot[6].IndicatorPointer.ListParam[0].Text    = "Exit the market at the end of the bar";
   ...
   strategy.Slot[7].IndicatorName    = "Rising Volume";
   ...
   strategy.Slot[7].IndicatorPointer = indicatorManager.CreateIndicator("Rising Volume", SlotTypes_CloseFilter);
   ...
   strategy.Slot[7].IndicatorPointer.ListParam[0].Text    = "Volume higher than the average";

   strategy.Slot[7].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[7].IndicatorPointer.NumParam[0].Caption = "Volume period";
   strategy.Slot[7].IndicatorPointer.NumParam[0].Value   = Slot7IndParam0;
   strategy.Slot[7].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[7].IndicatorPointer.NumParam[1].Caption = "Volume threshold";
   ...
   strategy.Slot[8].IndicatorName    = "Bollinger Bands";
   ...
   strategy.Slot[8].IndicatorPointer = indicatorManager.CreateIndicator("Bollinger Bands", SlotTypes_CloseFilter);
   ...
   strategy.Slot[8].IndicatorPointer.ListParam[0].Text    = "The bar closes below Upper Band";
   strategy.Slot[8].IndicatorPointer.ListParam[1].Enabled = true;
   strategy.Slot[8].IndicatorPointer.ListParam[1].Caption = "Smoothing method";
   strategy.Slot[8].IndicatorPointer.ListParam[1].Index   = 0;
   strategy.Slot[8].IndicatorPointer.ListParam[1].Text    = "Simple";
   strategy.Slot[8].IndicatorPointer.ListParam[2].Enabled = true;
   strategy.Slot[8].IndicatorPointer.ListParam[2].Caption = "Base price";
   strategy.Slot[8].IndicatorPointer.ListParam[2].Index   = 3;
   strategy.Slot[8].IndicatorPointer.ListParam[2].Text    = "Close";

   strategy.Slot[8].IndicatorPointer.NumParam[0].Enabled = true;
   strategy.Slot[8].IndicatorPointer.NumParam[0].Caption = "MA period";
   strategy.Slot[8].IndicatorPointer.NumParam[0].Value   = Slot8IndParam0;
   strategy.Slot[8].IndicatorPointer.NumParam[1].Enabled = true;
   strategy.Slot[8].IndicatorPointer.NumParam[1].Caption = "Multiplier";
...
/*STRATEGY CODE <?xml version=\"1.0\"?><strategy><programName>Forex Strategy Builder Professional</programName><programVersion>v3.8.2</programVersion><strategyName>NZDUSD30M MARTI</strategyName><profileName>Default profile</profileName><dataSourceName>FSB Demo data</dataSourceName><instrumentSymbol>NZDUSD</instrumentSymbol><instrumentPeriod>30</instrumentPeriod><sameDirSignalAction>Loser</sameDirSignalAction><oppDirSignalAction>Nothing</oppDirSignalAction><maxOpenLots>100</maxOpenLots><useAccountPercentEntry>True</useAccountPercentEntry><entryLots>1</entryLots><addingLots>10</addingLots><reducingLots>1</reducingLots><useMartingale>True</useMartingale><martingaleMultiplier>3</martingaleMultiplier><description>Exported on 5/10/2019 from Forex Strategy Builder Professional, v3.8.2</description><recommendedBars>1000</recommendedBars><openFilters>5</openFilters><closeFilters>2</closeFilters><firstBar>206</firstBar><minBarsRequired>207</minBarsRequired><permanentStopLoss usePermanentSL=\"False\" permanentSLType=\"Relative\">5</permanentStopLoss><permanentTakeProfit usePermanentTP=\"False\" permanentTPType=\"Relative\">1000</permanentTakeProfit><breakEven useBreakEven=\"False\">50</breakEven><slot slotNumber=\"0\" slotType=\"Open\"><indicatorName>Bar Opening</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Enter the market at the beginning of the bar</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>0</index><value>Open</value></listParam></slot><slot slotNumber=\"1\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Bollinger Bands</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>11</index><value>The bar opens above Lower Band after opening below it</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>MA period</caption><value>41</value></numParam><numParam paramNumber=\"1\"><caption>Multiplier</caption><value>2.71</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"2\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Moving Average</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Moving Average rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Period</caption><value>199</value></numParam><numParam paramNumber=\"1\"><caption>Shift</caption><value>4</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"3\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Oscillator of ATR</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Oscillator rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><numParam paramNumber=\"0\"><caption>First ATR period</caption><value>18</value></numParam><numParam paramNumber=\"1\"><caption>Second ATR period</caption><value>19</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"4\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>ADX</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>ADX rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>0</index><value>Bar range</value></listParam><numParam paramNumber=\"0\"><caption>Period</caption><value>2</value></numParam><numParam paramNumber=\"1\"><caption>Level</caption><value>0</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"5\" slotType=\"OpenFilter\" logicalGroup=\"A\"><indicatorName>Momentum MA Oscillator</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Oscillator rises</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Signal line method</caption><index>2</index><value>Exponential</value></listParam><listParam paramNumber=\"3\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>Momentum period</caption><value>15</value></numParam><numParam paramNumber=\"1\"><caption>Signal line period</caption><value>8</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>True</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"6\" slotType=\"Close\"><indicatorName>Bar Closing</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Exit the market at the end of the bar</value></listParam><listParam paramNumber=\"1\"><caption>Base price</caption><index>0</index><value>Close</value></listParam></slot><slot slotNumber=\"7\" slotType=\"CloseFilter\" logicalGroup=\"a\"><indicatorName>Rising Volume</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>Volume higher than the average</value></listParam><numParam paramNumber=\"0\"><caption>Volume period</caption><value>3</value></numParam><numParam paramNumber=\"1\"><caption>Volume threshold</caption><value>2.0</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot><slot slotNumber=\"8\" slotType=\"CloseFilter\" logicalGroup=\"a\"><indicatorName>Bollinger Bands</indicatorName><listParam paramNumber=\"0\"><caption>Logic</caption><index>0</index><value>The bar closes below Upper Band</value></listParam><listParam paramNumber=\"1\"><caption>Smoothing method</caption><index>0</index><value>Simple</value></listParam><listParam paramNumber=\"2\"><caption>Base price</caption><index>3</index><value>Close</value></listParam><numParam paramNumber=\"0\"><caption>MA period</caption><value>9</value></numParam><numParam paramNumber=\"1\"><caption>Multiplier</caption><value>1.97</value></numParam><checkParam paramNumber=\"0\"><caption>Use previous bar value</caption><value>False</value></checkParam><signalShift>0</signalShift><signalRepeat>0</signalRepeat><indicatorSymbol></indicatorSymbol><indicatorPeriod>M1</indicatorPeriod></slot></strategy> */
//+------------------------------------------------------------------+
