...
int init() {
   ...
   IndicatorShortName("TraderWawasan TE(" + MA_Period + ")");
      ...
      if (g_ibuf_120[li_4] > 0.0) {
         ...
         if (UseSignal > 0) {
            if (g_ibuf_120[li_4 + 1] < 0.0) {
               ...
               if (WarningMode > 0 && li_4 == 0) PlaySound("attention.wav");
