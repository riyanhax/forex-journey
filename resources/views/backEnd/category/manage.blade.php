      ...
      <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                 <div class="row">
                   <div class="col-sm-6">
                     <h6 class="card-title">Category Manage</h6>
                   </div>
                   <div class="col-sm-6">
                    <div class="shortcut-btn">
                       <a href="{{url('editor/category/add')}}"><i data-feather="plus"></i> New</a>
                    </div>
                   </div>
                 </div>
                 <div class="row">
                          ...
                          <tr>
                            ...
                            <td><div class="dropdown">
                                ...
                                <div class="dropdown-menu custom-action">
                                  ...
                                  @endif
                                  <li>
                                    <a class="dropdown-item" href="{{url('editor/category/edit/'.$value->id)}}">Edit</a>
                                  </li>
                              </td>
                          </tr>
                          @endforeach
