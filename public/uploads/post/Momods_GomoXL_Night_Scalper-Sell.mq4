...
extern string gs_264 = "Momods_GomoXL_Night_Scalper-Sell";
...
int start() {
   ...
   if (gi_296 > 0 && gi_296 <= (NightMaxTrades+DayMaxTrades)) {
      ...
      if (gi_316 && Bid - gd_236 >= PipStep * PointValue()) gi_308 = TRUE;
   }
   if (gi_296 < NewCycle) {
      gi_316 = FALSE;
      gi_308 = TRUE;
   ...
   if (ai_4 != 0) {
      for (int l_pos_36 = OrdersTotal() - 1; l_pos_36 >= 0; l_pos_36--) {
         if (OrderSelect(l_pos_36, SELECT_BY_POS, MODE_TRADES)) {
            ...
            if (OrderSymbol() == Symbol() || OrderMagicNumber() == g_magic_192) {
               if (OrderType() == OP_SELL) {
                  li_16 = NormalizeDouble((a_price_8 - Ask) / PointValue(), 0);
                  if (li_16 < ai_0) continue;
                  l_ord_stoploss_20 = OrderStopLoss();
                  l_price_28 = Ask + ai_4 * PointValue();
