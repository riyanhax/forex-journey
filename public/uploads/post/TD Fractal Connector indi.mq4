//+------------------------------------------------------------------+
//|                       Diagonal TD Fractal Break Outs Alerter.mq4 |
//|                                                                  |
//+------------------------------------------------------------------+
#property copyright "Mouteki"
#property link      ""
#property indicator_chart_window
#property indicator_buffers 2
#property indicator_color1 Lime /*Original #property indicator_color1 Red. Color of Upper TD Points*/
#property indicator_color2 Lime /*Original #property indicator_color2 Blue. Color of Lower TD Points*/
//---- input parameters
...
extern bool      TD=True;/*Default is false. True setting draws up and down arrows instead of dots on TD Points creating more clutter.*/ 
