...
@section('title', $postdetails->title)
@section('content')
                        ...
                        <div class="col-xl-4 col-md-4">
                            <div class="related-post">
                                <div class="title" style="height: 20px; overflow: hidden">
                                    <h6><a href="{{url(''.$value->slug.'/'.$value->id)}}">{!!str_limit($value->title,99999)!!}</a></h6>
                                </div>
                ...
                <div class="postcomment">
                    ...
                    <form action="{{url('member/post/comment')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group control-group increment comment-increment">
                                <div class="input-group-btn">
                    ...
                    <div class="single-post-comment">
                        ...
                        <div class="post-comment">
                            ...
                            <div class="d-flex justify-content-between mb-2 text-secondary">
                                ...
                                <div class="d-flex">
                                    <button data-toggle="modal" data-target="#replayModal{{$postcomment->id}}" class="px-2 text-secondary">Reply</button>
                                
                                
                                    @php
                                        $user = Session::get('memberId');
                                    @endphp
                                    @if($user == $cmemberInfo->id)
                                    <button data-toggle="modal" data-target="#commentEditModal{{$postcomment->id}}" class="px-2 text-secondary">Edit</button>
                                
                                    <form action="/member/post/comment/delete" method="post">
                                        @csrf
                                        <input type="hidden" name="commentId" id="commentId" value="{{$postcomment->id}}">
                                        <button class="px-2 text-secondary" type="submit"  onclick="return confirm('Are you sure?')">Delete</button>
                                    </form>
                                    @endif
                                </div>
                            ...
                            <div class="">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="d-flex justify-content-between text-secondary">
                                            ...
                                            <div class=" d-flex">
                                                ...
                                                $user = Session::get('memberId');
                                                @endphp
                                                @if($user == $replaymember->id)
                                                <button class="px-2 text-secondary" data-toggle="modal" data-target="#replyCommentEditModal{{$replaycomment->id}}">Edit</button>
                                                
                                                <form action="/member/post/comment-reply/delete" method="post">
                                                    @csrf
                                                    <input type="hidden" id="replyCommentId" name="replyCommentId" value="{{$replaycomment->id}}">
                                                    <button class="px-2 text-secondary" type="submit" onclick="return confirm('Are you sure?')">Delete</button>
                                                </form>
                                ...
                                <!--Modal-->
                                <div id="replyCommentEditModal{{$replaycomment->id}}" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="/member/post/comment-reply/edit" method="post">
                                            @csrf
                                            <input type="hidden" name="replyCommentId" id="replyCommentId" value="{{$replaycomment->id}}">
                                            <textarea class="tinymce-for-comment" id="updatedReplyComment" name="updatedReplyComment">
                                                <p>{!!$replaycomment->comment!!}</p>
                                            </textarea>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{url('member/post/comment-replay')}}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group control-group increment reply-comment-increment">
                            ...
                            <div id="commentEditModal{{$postcomment->id}}" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="/member/post/comment/edit" method="post">
                                            @csrf
                                            <input type="hidden" name="commentId" id="commentId" value="{{$postcomment->id}}">
                                            <textarea class="tinymce-for-comment" id="updatedComment" name="updatedComment">
                                                <p>{!!$postcomment->comment!!}</p>
                                            </textarea>
                                            <div class="d-flex justify-content-end m-3">
                                                <button class="btn btn-primary" type="submit">Update</button>
