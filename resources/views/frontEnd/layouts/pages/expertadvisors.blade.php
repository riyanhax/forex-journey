...
@section('title','Expert Advisors & Automated Trading | Journey Forex')
@section('content')
<!-- content area start -->
			...
			<div class="col-lg-10 col-md-9 col-sm-12">
				<div class="content">
					<div class="home-banner height66 mb-2">
						@foreach($expertadvisorstop as $cadone)
					...
					<div class="content-area">
						<div class="content-head" style="background-image: linear-gradient({{$color->title_background}}, {{$color->title_background2}})">
						    ...
						    @php
    						    $allposts = App\Post::where('category', 3)->orderBy('created_at','DESC')->paginate(20);
    						@endphp
					...
					<div class="home-banner height66">
						@foreach($expertadvisorsbottom as $cadone)
						<a href="{{$cadone->link}}" target="_blank">
    						<img class="w-100" src="{{asset($cadone->image)}}" alt="">
    					</a>
						@endforeach
			...
			<div class="col-lg-2 col-md-3 col-sm-12">
				<div class="esidebar d-inline">
					<div class="submit-strategy">
						<a href="{{url('member/post/create')}}">Share Your Experts</a>
					</div>
					<div class="esidebar-banner sticky-top">
						@foreach($expertadvisorsright as $value)
