...
//--- input parameters
extern double TradingLots=0.1;
extern int  TakeProfit= 32; //Take Profit (in Pips)
extern int  StopLoss= 24; //StopLoss (in Pips)
extern bool UseSLTP = true;
extern bool TradeOnce= false; // Trade Once (per Day)
extern string prefix="";
extern string postfix="";
extern double diff_val=0.25; // Difference Between Two Currencies Percentage
extern int Magic=2020; // Magic Number
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
